    ...
    fetch(siteUrl + "/api/files/fixityAlgorithm")
        ...
        .then(() => {
            ...
            switch (checksumAlgName) {
                case 'MD5':
                    js.src = "js/crypto-js-4.2.0/md5.js";
                    break;
                case 'SHA-1':
                    js.src = "js/crypto-js-4.2.0/sha1.js";
                    break;
                case 'SHA-256':
                    js.src = "js/crypto-js-4.2.0/sha256.js";
                    break;
                case 'SHA-512':
                    js.src = "js/crypto-js-4.2.0/x64-core.js";
                    head.appendChild(js);
                    js = document.createElement("script");
                    js.type = "text/javascript";
                    js.src = "js/crypto-js-4.2.0/sha512.js";
                    break;
                default:
                    js.src = "js/crypto-js-4.2.0/md5.js";
            }
